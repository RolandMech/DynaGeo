...
date="2006-12-27T19:28:47">
</edited>
<environment>
<commands>
7984877C812F1E
</commands>
<links forward="ellipse_1.geo">
</links>
</environment>
</header>
<windowdata>
...
width="7.26722393809454" height="4.76250112447943">
</position>
<text>
<![CDATA[
<i><b>Aufgaben:<br></b></i><br>1. Gibt es noch mehr Punkte, die von 
F<sub>1</sub> den Abstand 5 cm haben und gleichzeitig von 
F<sub>2</sub> den Abstand 3 cm?<br><br>2. Wo liegen alle Punkte, die 
von F<sub>1</sub> den Abstand 3 cm haben und gleichzeitig von 
F<sub>2</sub> den Abstand 5 cm?<br><br>3. Wo liegen alle Punkte, die 
von F<sub>1</sub> und F<sub>2</sub> jeweils den Abstand 4 cm 
haben?<br><br>4. In den vorigen Aufgabenteilen sind insgesamt 5 
Punkte gesucht. Wenn Du sie alle korrekt konstruiert hast, kannst Du 
Deine Lösung testen lassen.
]]>
</text>
</TextBox>
<TextBox id="15" name="dummy5">
<position x="0.599722363823336" y="7.3025017242018" 
width="6.2794459270914" height="3.19263964270658">
</position>
<text>
<![CDATA[
<i><b>Hilfe:</b></i> (Klicke auf den Pfeil!)<br><hr><br>Wo liegen 
alle Punkte, die von einem gegebenen Punkt M einen vorgegebenen 
Abstand r haben?<br><hr><br>
]]>
</text>
</TextBox>
...
<CheckControl id="18" name="go1">
<appearance visible="false">
</appearance>
<parents>
16
</parents>
<cc_data term="incid(@1, e) and incid(@2, e) and incid(@3, e) and incid(@4, e) and incid(@5, e)" 
vars="@1=Punkt@2=Punkt@3=Punkt@4=Punkt@5=Punkt" hint="Gib die 5 konstruierten Punkte 
ein!">
</cc_data>
</CheckControl>
</objlist>
